...
public class CircularSlider extends Region {
	 ...
	 *
	 * -fx-tick-length
	 * -fx-tick-mark-visible (-fx-show-tick-marks)
	 *
	 * -fx-minor-tick-length
	 * -fx-minor-tick-count (fx-minor-tick-count)
	 * -fx-minor-tick-visible
	 *
	 * -fx-tick-unit (-fx-major-tick-unit) (default 60 seconds)
	 *
     ...
     */
    private IntegerProperty minorTickCount = new StyleableIntegerProperty(6) {
        @Override protected void invalidated() {
            invalidateRange();
            requestAxisLayout();
        }
    ...
    private DoubleProperty tickUnit = new StyleableDoubleProperty(60) {
        @Override protected void invalidated() {
            invalidateRange();
            requestAxisLayout();
        }
    ...
    public CircularSlider() {
        getStyleClass().setAll("axis", "circular-slider");
	}
